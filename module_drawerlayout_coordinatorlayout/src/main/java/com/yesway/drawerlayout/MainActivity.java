...
//        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new CoordinatorListFragment(), "菜单1");
        adapter.addFragment(new CoordinatorListFragment(), "菜单2");
        adapter.addFragment(new CoordinatorListFragment(), "菜单3");
