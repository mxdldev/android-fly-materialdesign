...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_menu_recycleview_swipe);
    ...
    private static class GroupAdapter extends RecyclerView.Adapter<GroupViewHolder> {
        ...
        static final int VIEW_TYPE_NON_STICKY = R.layout.item_menu_main_recycleview_swipe;
        static final int VIEW_TYPE_STICKY = R.layout.item_menu_sticky_recycleview_swipe;
