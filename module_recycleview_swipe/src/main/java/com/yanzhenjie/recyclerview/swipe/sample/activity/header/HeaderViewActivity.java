...
public class HeaderViewActivity extends AppCompatActivity implements SwipeItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycleview_swipe_recycleview_swipe);
        ...
        // HeaderView。
        View headerView = getLayoutInflater().inflate(R.layout.layout_header_recycleview_swipe, recyclerView, false);
        ...
        // FooterView。
        View footerView = getLayoutInflater().inflate(R.layout.layout_footer_recycleview_swipe, recyclerView, false);
