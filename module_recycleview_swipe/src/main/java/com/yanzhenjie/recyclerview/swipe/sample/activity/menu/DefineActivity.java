...
public class DefineActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_menu_define_recycleview_swipe;
    }
    ...
    private static class DefineAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_menu_define_recycleview_swipe, parent, false));
        }
...
//                }
//                case R.id.btn_start: {
//                    Toast.makeText(v.getContext(), "我是第" + getAdapterPosition() + "个Item的中间的Button"12114 Toast.LENGTH_SHORT).show();
//                    break;
//                }
