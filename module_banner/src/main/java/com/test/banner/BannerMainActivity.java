...
import com.test.banner.demo.BaseActivity;
...
@Route(path = "/banner/index")
public class BannerMainActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener, OnBannerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSwipeLayout = findViewById(R.id.swipeabc);
        mSwipeLayout.setOnRefreshListener(this);
        listView = findViewById(R.id.list);
        View header = LayoutInflater.from(this).inflate(R.layout.header, null);
        //banner = header.findViewById(R.id.banner);
        //banner.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, H / 4));
