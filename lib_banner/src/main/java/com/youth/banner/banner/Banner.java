package com.youth.banner.banner;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    public String tag = "com/youth/banner/banner";
     ...
     * current page in the com.youth.banner.view hierarchy in an idle state. Pages beyond this
     * limit will be recreated from the adapter when needed.
     *
     * @param limit How many pages will be kept offscreen in an idle state.
     * @return com.youth.banner.Banner
     */
    ...
    private void setTitleStyleUI() {
        if (titles.size() != imageUrls.size()) {
            throw new RuntimeException("[com.youth.banner.Banner] --> The number of titles and images is different");
        }
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            ...
            if (imageLoader != null)
                ...
                Log.e(tag, "Please set images com.youth.banner.loader.");
        }
    }
